...
export const Navigation = () => {
  return (
    <nav className="max-w-[1440px] mx-auto px-[30px] pt-[20px] pb-[20px] flex justify-between items-center border-b border-[#F0F0F0]">
      <svg
        width="91"
        height="32"
        viewBox="0 0 91 32"
      ...
      <div className="flex items-center ml-[30px] space-x-[14px]">
      ...
      <div className="flex items-center ml-auto space-x-[20px]">
        ...
        <Link href="" className="miro__btn h-[50px]">Sign up free →</Link>
      </div>
    </nav>
  );
};
...
const ArrowDown = () => {
  return (
    <div className="inline-block px-2 leading-0">
      <div className="inline-block leading-0 size-2.5 border-2 border-t-transparent border-r-transparent -rotate-45 -translate-y-[3px]"></div>
    </div>
  );
};
